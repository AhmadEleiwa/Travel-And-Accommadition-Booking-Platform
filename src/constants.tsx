...
export const MOCK_HOTELS: Hotel[] = [
  {
    ...
    starRating: 5,
    description:
      "The Ritz Paris is a palace hotel in the heart of Paris. Since its opening in 1898, it has become a symbol of French luxury and refinement.",
    thumbnail:
  ...
  },
  {
    ...
    starRating: 5,
    description:
      'Iconic luxury hotel offering breathtaking views of Tokyo and Mount Fuji. Known for its appearance in "Lost in Translation".',
    thumbnail:
  ...
  },
  {
    ...
    starRating: 5,
    description:
      "The world's only 7-star hotel, standing on an artificial island. Unparalleled luxury and architecture.",
    thumbnail:
